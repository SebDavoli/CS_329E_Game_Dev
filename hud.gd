...
func update_health(health):
	...
	if health == 100:
		$Health.texture = ResourceLoader.load("res://Art/HP_100.png")
	if health == 80:
		$Health.texture = ResourceLoader.load("res://Art/HP_80.png")
	if health == 60:
		$Health.texture = ResourceLoader.load("res://Art/HP_60.png")
	if health == 40:
		$Health.texture = ResourceLoader.load("res://Art/HP_40.png")
	if health == 20:
		$Health.texture = ResourceLoader.load("res://Art/HP_20.png")
	if health == 0:
		$Health.texture = ResourceLoader.load("res://Art/HP_0.png")	
